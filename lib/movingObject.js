(function() {
  ...
  MovingObject.prototype.move = function () {
    ...
    movePos[0] += this.vel * Math.cos(this.dir);
    movePos[1] += this.vel * Math.sin(this.dir);
    if (this.wrappable()) movePos = this.game.wrap(movePos);
    return movePos;
  };
  ...
  MovingObject.prototype.randomDir = function () {
